...
class GamesAdapter(games: MutableList<DocumentSnapshot>): RecyclerView.Adapter<GamesItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: GamesItemViewHolder, position: Int) {
        ...
        try {
            ...
            holder.layout.delete_button.setOnClickListener() {
                val action = ListgamesFragmentDirections.actionListgamesFragmentToDeletegameFragment(holder.layout.insert_title.text.toString(),
            ...
            holder.layout.edit_button.setOnClickListener() {
                val action = ListgamesFragmentDirections.actionListgamesFragmentToEditgameFragment(holder.layout.insert_title.text.toString(),
                    holder.layout.insert_developer.text.toString(),
                    holder.layout.insert_platform.text.toString(),
                    holder.layout.Beaten.isChecked,
                    holder.layout.Digital.isChecked,
            ...
            holder.layout.info_button.setOnClickListener() {
                val action = ListgamesFragmentDirections.actionListgamesFragmentToInfogameFragment(holder.layout.insert_title.text.toString())
                it.findNavController().navigate(action)
            }
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GamesItemViewHolder {
        ...
        if (empty) {
            val view = layoutInflater.inflate(R.layout.empty_item_list_view, parent, false) as ConstraintLayout
